...
function Tutorials() {
  ...
  return (
    <div>
      <div className={tutorials.marqueeCont}>
        <div className={tutorials.marquee}>
          <div className={tutorials.track}>
            <div className={tutorials.content}>
              <h2>
                <DashOutlined /> {t("marquee")} <DashOutlined />
              </h2>
            </div>
          </div>
        </div>
      ...
      <h2 className={tutorials.title}>
        <ReadOutlined className={tutorials.bookIcon} /> {t("courses.heading")}
      </h2>
      <div className={tutorials.container} id="#courses">
        {cards.map((key, idx) => (
          <Card
          ...
          >
            ...
            />
            <div className={tutorials.details}>
              <p>{t(`courses.${key}.weeks`)}</p>
              <p>{t(`courses.${key}.hours`)}</p>
            </div>
            ...
            <Link href="/courses">
              <button>
                {t("courses.learnMore")} <ArrowRightOutlined />
              </button>
            </Link>
          </Card>
        ))}
