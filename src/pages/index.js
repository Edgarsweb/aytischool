      ...
      <main className={styles.main}>
            ...
            <div className={styles.block}>
              ...
              <Link href="/courses">
                <button className={styles.button}>
                  <EditOutlined className={styles.icon} /> {t("hero.cta")}
                </button>
              </Link>
            </div>
        ...
        <div className={styles.whyUs}>
          ...
          <div>
            <div className={styles.block}>
              <h2>
                {t("enrollment.title1")} {t("enrollment.title2")}
              </h2>
              <p>{t("enrollment.text")}</p>
              <Link href="/contact">
                <button className={styles.button}>
                  <MailOutlined className={styles.icon} /> {t("enrollment.cta")}
                </button>
              </Link>
            </div>
          </div>
